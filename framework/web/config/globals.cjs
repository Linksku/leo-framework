module.exports = {
  ...
  showAlert: ['./framework/web/stores/AlertStore', 'showAlert'],
  showConfirm: ['./framework/web/stores/AlertStore', 'showConfirm'],
  ...
  usePushHome: ['./framework/web/stores/history/usePushHome', 'default'],
  ...
  useHomeTab: ['./framework/web/stores/history/HistoryStore', 'useHomeTab'],
