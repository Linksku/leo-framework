...
function insertOne<T extends EntityClass, Obj extends ModelPartialExact<T, Obj>>(
  this: T,
  obj: Obj,
  opts?: {
...
async function insertOne<T extends EntityClass, Obj extends ModelPartialExact<T, Obj>>(
  this: T,
  obj: Obj,
  {
