...
const globals = {
  ...
  useLogLifecycle: ['./web/lib/hooks/useLogLifecycle', 'default'],
  ...
  useRouteStore: ['./web/stores/RouteStore', 'useRouteStore'],
  ...
  useUIFrameStore: ['./web/stores/UIFrameStore', 'useUIFrameStore'],
  // Constate split.
  ...
  useAuthState: ['./web/stores/AuthStore', 'useAuthState'],
  ...
  useReloadPage: ['./web/stores/UIFrameStore', 'useReloadPage'],
